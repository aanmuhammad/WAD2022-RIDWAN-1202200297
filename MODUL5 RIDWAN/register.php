        ...
        <div class="panel panel-info" >
            ...
            <div style="padding-top:30px" class="panel-body" >
                ...
                <form id="registerform" class="form-horizontal" action="" method="post" role="form">       
                    ...
                    <div style="margin-bottom: 25px" class="input-group">
                        <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                        <input id="register-email type="text" class="form-control" name="email" value="<?php echo $email?>" placeholder="email">                                        
                    </div>
                    <div style="margin-bottom: 25px" class="input-group">
                    ...
                    <div class="input-group">
                        <div class="checkbox">
                        <label>
                            <input id="register-remember" type="checkbox" name="remember" value="1" <?php if($remember == '1') echo "checked"?>> Remember Me
                        </label>
                        </div>
                    </div>
